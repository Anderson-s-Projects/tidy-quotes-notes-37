...
const Editor: React.FC<EditorProps> = ({ 
  ...
  return (
    <div className="flex flex-col h-full relative neu-flat m-2 md:m-0 rounded-lg">
      {!selectedNoteId ? (
          ...
          <div className="text-center space-y-4 p-6 neu-card max-w-md">
            ...
            <div className="flex justify-center gap-2 mt-4">
              <button 
                ...
                className="md:hidden py-2 px-3 rounded-lg neu-button flex items-center gap-2"
              >
                <FileIcon size={16} />
                View Notes
              </button>
        ...
        <>
          <div className="p-3 border-b border-border flex items-center justify-between">
            <div className="md:hidden flex items-center gap-2">
              <button
                onClick={onMobileSidebarToggle}
                className="h-8 w-8 rounded-lg neu-button flex items-center justify-center"
              >
                <Menu size={16} />
              </button>
              <button
          ...
          <div className="flex-1 overflow-hidden editor-container p-2">
            {isPreviewMode ? (
              ...
              <textarea
                ...
                className="editor-content custom-scrollbar resize-none bg-transparent border-none outline-none focus:ring-0 font-mono text-sm leading-relaxed p-4 neu-input h-full"
              />
            )}
          </div>
          ...
          <div className="p-3 border-t border-border flex items-center justify-between text-xs text-muted-foreground">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1">
                <button 
                  onClick={handleSave}
                  className="h-7 px-2 rounded-lg neu-button flex items-center text-xs"
                >
                ...
                <button 
                  ...
                  className="h-7 px-2 rounded-lg neu-button flex items-center text-xs text-destructive"
                >
